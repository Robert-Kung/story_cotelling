...
# class of the dialogue evalution model
# input sequence: [CLS] plot_point [SEP] plot_point [SEP]...[SEP] plot_point [SEP]
# output: score of dialogue history (0 to 10)
class DialogueEvalutionModel(nn.Module):
    def __init__(self, device):
        super(DialogueEvalutionModel, self).__init__()
...
# input sequence: [CLS] plot_point [SEP] plot_point [SEP]...[SEP] plot_point [SEP]
# output: score of dialogue history (0 to 10)
class DialogueEvalutionDataset(torch.utils.data.Dataset):
...
class DialogueEvalutionTrainer:
